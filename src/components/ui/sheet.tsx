...
>(({ className, ...props }, ref) => (
  <div className="fixed inset-0 z-50 bg-background/80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0" />
))
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      {/* Default close button REMOVED from here to allow custom placement in Navbar */}
      {/* 
