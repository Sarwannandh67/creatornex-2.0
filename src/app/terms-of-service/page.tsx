    ...
    <SectionWrapper className="bg-gradient-to-b from-background to-card pt-24 md:pt-32">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-muted-foreground prose prose-invert prose-lg dark:prose-invert max-w-none">
          ...
          <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the [Your Website URL] website (the "Service") operated by CreatorNex LLC ("us", "we", or "our").</p>
          ...
          <p>The Service and its original content, features, and functionality are and will remain the exclusive property of CreatorNex LLC and its licensors. [Placeholder: Add details about copyright, trademarks, etc.]</p>

          <h2 className="text-2xl font-semibold text-foreground !mt-8 !mb-4">3. Links To Other Web Sites</h2>
          <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by CreatorNex LLC. CreatorNex LLC has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party web sites or services. [Placeholder: Add further disclaimers if necessary].</p>

          <h2 className="text-2xl font-semibold text-foreground !mt-8 !mb-4">4. Limitation Of Liability</h2>
          <p>In no event shall CreatorNex LLC, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service. [Placeholder: This is standard but verify with legal counsel].</p>
